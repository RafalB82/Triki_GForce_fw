...
| **v0.3.8_scan** | diagnostyka: `pin_scan()` wszystkich wolnych GPIO (60ms/pin, pull-down, GPIOTE hi-acc, DRDY wlaczone) pod katme krawedzi DRDY; `TRIKIG_PIN_SCAN ?= 0`; hex sha256 `c4407a51…` (tylko diagnostyka) |
