...
7. INT1/DRDY — **ZAMKNIETE 0.3.6 [P]**: DRDY = INT2 ukladu (pin 9) -> **P0.10** nRF (potwierdzone plyta). 0.3.3/0.3.4 nie dzialalo, bo FW wlaczal DRDY na INT1_CTRL (0x0D). Od 0.3.5: INT2_CTRL (0x0E); probe: P0.10 pierwsza (potwierdzony), polaryzacja auto; wynik RTT `S2 DRDY ok pin=P0.10 pol=y` / `drdy_mode` 1-2.
